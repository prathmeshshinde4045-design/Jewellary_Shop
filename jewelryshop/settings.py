...
# Serve these folders in development (add project-level static if used)
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),                     # optional project static
    os.path.join(BASE_DIR, 'jewelryshop', 'static'),      # your app static
]

# Collectstatic target (keep separate from source directories)
